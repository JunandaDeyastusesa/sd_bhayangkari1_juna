        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="w-full col-md-12 row">
                    <div class="col-md-4 col-12 card  flex-row justify-content-center d-none d-md-flex "
                        ...
                        <div class="flex-grow-1 ms-3 ml-4">
                            <h5 class="mt-2">{{ Auth::guard('guru')->user()->nama_guru }}<br> <span
                                    style="font-size: 15px;">{{ Auth::guard('guru')->user()->level }}</span></h5>
