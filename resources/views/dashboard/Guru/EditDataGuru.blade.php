        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="guruForm" action="{{ route('guru.update', $DataGuru->id) }}" method="POST"
                            ...
                            <div class="col-md-6 row ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="agama" class="custom-select form-control" id="exampleSelectBorder">
                                        ...
                                        <option value="islam" {{ $DataGuru->agama == 'islam' ? 'selected' : '' }}>
                                            Islam
                                        </option>
                                        <option value="kristen" {{ $DataGuru->agama == 'kristen' ? 'selected' : '' }}>
                                            Kristen
                                        </option>
                                        <option value="hindu" {{ $DataGuru->agama == 'hindu' ? 'selected' : '' }}>
                                            Hindu
                                        </option>
                                        <option value="budha" {{ $DataGuru->agama == 'budha' ? 'selected' : '' }}>
                                            Budha
                                        </option>
                                        <option value="khongucu" {{ $DataGuru->agama == 'khongucu' ? 'selected' : '' }}>
                                            Khongucu
                                        </option>
                                    </select>
                                    @error('agama')
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <select name="jenis_kelamin" class="custom-select form-control"
                                        ...
                                        <option
                                            value="laki laki" {{ $DataGuru->jenis_kelamin == 'laki laki' ? 'selected' : '' }}>
                                            laki laki
                                        </option>
                                        <option
                                            value="perempuan" {{ $DataGuru->jenis_kelamin == 'perempuan' ? 'selected' : '' }}>
                                            perempuan
                                        </option>
                                    </select>
                                    @error('jenis_kelamin')
                            ...
                            <div class="col-md-12 row ">
                                <div class="form-group col-md-4 ">
                                    ...
                                    <select name="level" class="custom-select form-control"
                                        ...
                                        <option
                                            value="kepala sekolah" {{ $DataGuru->level == 'kepala sekolah' ? 'selected' : '' }}>
                                            Kepala Sekolah
                                        </option>
                                        <option
                                            value="tata usaha" {{ $DataGuru->level == 'tata usaha' ? 'selected' : '' }}>
                                            Tata Usaha
                                        </option>
                                        <option
                                            value="wali kelas" {{ $DataGuru->level == 'wali kelas' ? 'selected' : '' }}>
                                            Wali Kelas
                                        </option>
                                        <option
                                            value="guru mapel" {{ $DataGuru->level == 'guru mapel' ? 'selected' : '' }}>
                                            Guru Mapel
                                        </option>
                                    </select>
                                    @error('level')
                                    ...
                                    <select name="kelas_id" class="custom-select form-control"
                                        ...
                                        @foreach ($kelas as $class)
                                            @if ($class->angka_kelas < 7)
                                                <option
                                                    value="{{ $class->id }}" {{$DataGuru->angka_kelas == $class->id ? 'selected' : '' }}>{{ $class->angka_kelas }}</option>
                                            @elseif($class->angka_kelas > 7)
                                            @endif
                                        @endforeach
                                        <option value="8" {{$DataGuru->angka_kelas == 8 ? 'selected' : '' }}>Tidak
                                            Memiliki Kelas (untuk guru yang tidak mengampu kelas)
                                        </option>
                                        <option value="9" {{$DataGuru->angka_kelas == 9 ? 'selected' : '' }}>Tidak
                                            Memiliki Kelas Tetap (Untuk guru mapel yang tidak memiliki kelas tetap)
                                        </option>
                                    </select>
                                    @error('kelas_id')
                                    <div class="text-danger">{{ $message }}</div>
                               ...
                               <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="status" class="custom-select form-control"
                                        ...
                                        <option value="aktif" {{ $DataGuru->status == 'aktif' ? 'selected' : '' }}>
                                            Aktif
                                        </option>
                                        <option
                                            value="non aktif" {{ $DataGuru->status == 'non aktif' ? 'selected' : '' }}>
                                            Non Aktif
                                        </option>
                                    </select>
                                    @error('status')
